...
const card = document.querySelector('.card'); // QuerySelector utiliza una sintaxis como de selector de CSS, por lo tanto si deseas seleccionar una clase, debe tener un punto al inicio...

// nota como a pesar de tener múltiples cards, solo selecciona 1

console.log(card);

// al ser una sintaxis tipo CSS puedes utilizar selectores más específicos...
...
// También los ID pueden tener selectores específicos como el de arriba, pero recuerda un ID es único asi que no tendría mucho sentido no?
